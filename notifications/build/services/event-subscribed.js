...
const notify = new notification_repository_1.default();
const handleCreateNotification = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId, message } = data;
    return yield notify.createNotification({ userId, message });
});
